<%-- 
    Document   : AnotacaoDiversaCRU
    Created on : 01/02/2019, 12:53:49
    Author     : x369482
--%>
...
<html>
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <!-- AJUSTAR PARA A ANOTAÇAO DIVERSA
                            ...
                            <div class="form-horizontal">
                                <div class="tabbable">
                                    ...
                                    <div class="tab-content profile-edit-tab-content" >
                                        ...
                                        <div id="anot-diversas" class="tab-pane active">        
                                            <form action="ControllerServlet?acao=" method="POST" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-2 col-xs-12">
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-8 col-xs-12" name="cdLote" 
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-4 col-xs-12" name="cdExpediente" 
                                                                       value="${cadSic.cdExpediente}" placeholder="Código do Expediente" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-4 col-xs-12" name="cdExpediente" 
                                                                       placeholder="Código do Expediente" >
                                                            </c:when>
                                                            <c:otherwise>
                                                                <span class="lbl">${cadSic.cdLote}</span> 
                                                            </c:otherwise>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="nmInteressado" 
                                                                       value="${cadSic.nmInteressado}" placeholder="Nome do Interessado" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="nmInteressado" 
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="dsAssunto" 
                                                                       value="${cadSic.dsAssunto}" placeholder="Descrição do Assunto" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="dsAssunto" 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-5 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-11 col-xs-12" name="dsDespacho" 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="inline col-xs-5 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <div class="input-group col-xs-5 col-xs-12">
                                                                    <input class="form-control" id="id-date-picker-1" name="dtAnotacao" 
                                                                           value="${cadSic.dtAnotacao}" type="date" placeholder="dd/mm/aaaa" required="required">
                                                            ...
                                                            <c:when test="${execucao == 'insert'}">
                                                                <div class="input-group col-xs-5 col-xs-12">
                                                                    <input class="form-control" id="id-date-picker-1" name="dtAnotacao" type="date" 
                                                    ...
                                                    <label class="inline col-xs-3 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <div class="input-group col-xs-5 col-xs-12">
                                                                    <input class="form-control" id="id-date-picker-1" name="dtPublicacao" 
                                                                           value="${cadSic.dtPublicacao}" type="date" placeholder="dd/mm/aaaa" required="required">
                                                                    <span class="input-group-addon">
                                                                        <i class="fa fa-calendar bigger-110"></i>
                                                                    </span>
                                                                </div>
                                                            ...
                                                            <c:when test="${execucao == 'insert'}">
                                                                <div class="input-group col-xs-5 col-xs-12">
                                                                    <input class="form-control" id="id-date-picker-1" name="dtPublicacao" type="date" 
                                                                           placeholder="dd/mm/aaaa"  required="required">
                                                                    <span class="input-group-addon">
                                                                        <i class="fa fa-calendar bigger-110"></i>
                                                                    </span>
