<%-- 
    Document   : CatFinalidadeCRU
    Created on : 04/10/2018, 15:38:07
    Author     : d732229
--%>
...
<!--Parametros para paginação e exibir campos do View, Edit, Inserit-->    
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            <li><i class="ace-icon fa fa-folder"></i> Categoria Finalidade</li>
        </ul>
    </div>    
            ...
            <div class="widget-box">
                <div class="widget-header">
                    <h4 class="widget-title"><span class="fa fa-folder-o"></span> 
                        ...
                        Categoria Finalidade</h4>
                </div>

                <div class="widget-body">
                    <div class="widget-main no-padding">
                        <form action="ControllerServlet?acao=CatFinalidadeCU" method="POST">
                            <input type="hidden" name="execucao" value="${execucao}" />
                            <input type="hidden" name="pkCatFinalidade" value="${catFin.pkCatFinalidade}" />
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-xs-12">
                                        <c:choose>
                                            ...
                                            <c:when test="${execucao=='edit'}">
                                                <input type="text" name="sigla" value="${catFin.sgCatFinalidade}" id="sigla" onblur="alertSigla(this)" onfocus="alertSiglaClear()" class="col-sm-4 col-sm-12" required="required" maxlength="9">
                                                &nbsp;<span id="alertSigla"></span>
                                            </c:when>
                                            <c:otherwise>
                                                <label class="lead"><c:out value="${catFin.sgCatFinalidade}" /></label>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                    <br /><br /><br />
                                    ...
                                    <div class="col-sm-9 col-xs-12 control-label no-padding-right" for="form-field-1">
                                        <c:choose>
                                            <c:when test="${execucao=='insert'}" >
                                                <input type="text" id="form-field-1" name="catFinalidade" placeholder="Nome completo da categoria" class="col-xs-12 col-sm-12" required="required">
                                            </c:when>
                                            <c:when test="${execucao=='edit'}">
                                                <input type="text" id="form-field-1" name="catFinalidade" value="${catFin.nmCatFinalidade}" class="col-xs-12 col-sm-12" required="required">
                                            </c:when>
                                            <c:otherwise>
                                                <label class="lead"><c:out value="${catFin.nmCatFinalidade}" /></label >
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                    <br /><br /><br />
                            ...
                            <div class="form-actions center">
                                <button class="btn btn-yellow" type="reset" onclick=" location.href='ControllerServlet?acao=CatFinalidadeLista';">
