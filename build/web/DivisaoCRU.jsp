...
<!--Parametros para paginação e exibir campos do View, Edit, Inserit-->    
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            <li><i class="ace-icon fa fa-folder"></i> Divisão</li>
        </ul>
    </div>    
            ...
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <div class="widget-main no-padding">
                        <form action="ControllerServlet?acao=DivisaoCU" method="POST">
                            <input type="hidden" name="execucao" value="${execucao}" />
                            <input type="hidden" name="pkDivisao" value="${dv.pkDivisao}" />
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-xs-12">
                                        <c:choose>
                                            <c:when test="${execucao=='insert'}" >
                                                <input type="text" name="sigla" placeholder="Sigla da divisão" id="sigla" onblur="alertSigla(this)" onfocus="alertSiglaClear()" class="col-sm-7 col-sm-12" required="required" maxlength="26">
                                                &nbsp;<span id="alertSigla"></span>
                                            </c:when>
                                            <c:when test="${execucao=='edit'}">
                                                <input type="text" name="sigla" value="${dv.sgDivisao}" id="sigla" onblur="alertSigla(this)" onfocus="alertSiglaClear()" class="col-sm-7 col-sm-12" required="required" maxlength="26">
                                                &nbsp;<span id="alertSigla"></span>
                                            </c:when>
                                            <c:otherwise>
                                                <label class="lead"><c:out value="${dv.sgDivisao}" /></label>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                    <br /><br /><br />
                                    
                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Divisão: </label>
                                    <div class="col-sm-9 col-xs-12 control-label no-padding-right" for="form-field-1">
                                        <c:choose>
                                            <c:when test="${execucao=='insert'}" >
                                                <input type="text" id="form-field-1" name="divisao" placeholder="Nome completo da Divisão" class="col-xs-12 col-sm-12" required="required">
                                            </c:when>
                                            <c:when test="${execucao=='edit'}">
                                                <input type="text" id="form-field-1" name="divisao" value="${dv.nmDivisao}" class="col-xs-12 col-sm-12" required="required">
                                            </c:when>
                                            <c:otherwise>
                                                <label class="lead"><c:out value="${dv.nmDivisao}" /></label >
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                    <br /><br /><br />
                                    ...
                                    <div class="col-sm-9 col-xs-12">
                                        ...
                                        <c:choose>
                                            ...
                                            <c:when test="${execucao=='edit'}">
                                                <input type="text" id="form-field-1"  value="${dv.nmNrSimproc}" name="nrSimproc" class="col-xs-12 col-sm-12" >
                                            </c:when>
                                            <c:otherwise>
                                                <label class="lead"><c:out value="${dv.nmNrSimproc}" /></label>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                    <br /><br /><br />
                                    ...
                                    <div class="col-sm-9 col-xs-12">
                                        <c:choose>
                                            ...
                                            <c:when test="${execucao=='edit'}">
                                                <input type="text" id="form-field-1" name="nrSei" value="${dv.nmNrSei}" class="col-xs-12 col-sm-12">
                                            </c:when>
                                            <c:otherwise>
                                               <label class="lead"><c:out value="${dv.nmNrSei}" /></label>
                                            </c:otherwise>
                                        </c:choose>
                                    </div>
                                    <br /><br /><br />
                            ...
                            <div class="form-actions center">
                                <button class="btn btn-yellow" type="reset" onclick=" location.href='ControllerServlet?acao=DivisaoLista';">
