...
public final class PainelAdm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <li><i class=\"ace-icon fa fa-cog\"></i> Painel Administrativo</li>\r\n");
      ...
      out.write("                                <button class=\"btn btn-primary btn-white btn-block\" onclick=\" location.href = 'ControllerServlet?acao=UsuarioListaPaginada';\">\r\n");
  ...
  private boolean _jspx_meth_c_if_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${sessionPerfil == 'Administrador'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    ...
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("\r\n");
        out.write("                                <div class=\"infobox btn-group-lg \">\r\n");
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\"location.href = 'ControllerServlet?acao=DivisaoLista';\">\r\n");
        out.write("                                        <i class=\"ace-icon fa fa-folder\"></i>\r\n");
        out.write("                                        Divisão\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        out.write("                                <div class=\"infobox btn-group-lg\">\r\n");
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\"location.href = 'ControllerServlet?acao=SetorLista';\">\r\n");
        out.write("                                        <i class=\"ace-icon fa fa-folder\"></i>\r\n");
        out.write("                                        Núcleo\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        out.write("\r\n");
        out.write("                                <div class=\"infobox btn-group-lg disabled-li-menu\">\r\n");
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\"location.href = 'ControllerServlet?acao=CargoLista';\">\r\n");
        out.write("                                        <i class=\"ace-icon fa fa-folder\"></i>\r\n");
        out.write("                                        Cargo\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        ...
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\"location.href = 'ControllerServlet?acao=PerfilLista';\">\r\n");
        out.write("                                        <i class=\"ace-icon fa fa-folder\"></i>\r\n");
        out.write("                                        Perfil no Sistema\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        out.write("                            ");
  ...
  private boolean _jspx_meth_c_if_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ ('DDPI' == sessionSgDivisao && sessionSgSetor == 'SCL')  || sessionPerfil == 'Administrador'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    ...
    if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\" location.href = 'ControllerServlet?acao=TipoAutoCessaoLista';\">\r\n");
        out.write("                                        Tipo de Auto de Cessão\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        out.write("\r\n");
        out.write("                                <div class=\"btn-group-lg infobox\" title=\"\">\r\n");
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\" location.href = 'ControllerServlet?acao=CatAutoCessaoLista';\">\r\n");
        out.write("                                        Categoria Auto de Cessão\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        out.write("\r\n");
        out.write("                                <div class=\"btn-group-lg infobox\" title=\"\">\r\n");
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\"location.href = 'ControllerServlet?acao=CatFinalidadeLista';\">\r\n");
        out.write("                                        Categoria Finalidade\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        out.write("                                <div class=\"btn-group-lg infobox\">\r\n");
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\"location.href = 'ControllerServlet?acao=CatSubFinalidadeLista';\">\r\n");
        out.write("                                        SubCategoria Finalidade\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        out.write("                            </div>\r\n");
        out.write("\r\n");
        ...
        out.write("                            <div class=\" infobox-chart col-xs-10\" style=\" padding-top:30px\">\r\n");
        out.write("                                <div class=\"btn-group-lg infobox\">\r\n");
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\"location.href = 'ControllerServlet?acao=CatContrapartidaLista';\">\r\n");
        out.write("                                        Categoria contrapartida\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        out.write("\r\n");
        out.write("                                <div class=\"btn-group-lg infobox\">\r\n");
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\"location.href = 'ControllerServlet?acao=TipoDispLegalLista';\">\r\n");
        out.write("                                        Tipo de Dispositivo Legal\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        out.write("\r\n");
        out.write("                                <div class=\"btn-group-lg disabled-li-menu infobox\">\r\n");
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\"location.href = 'ControllerServlet?acao=';\">\r\n");
        out.write("                                        Nível Administração\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div> \r\n");
        out.write("\r\n");
        out.write("                                <div class=\"btn-group-lg disabled-li-menu infobox\">\r\n");
        out.write("                                    <button class=\"btn btn-primary btn-white btn-block\" onclick=\" location.href = 'ControllerServlet?acao=';\">\r\n");
        out.write("                                        Categoria da Entidade\r\n");
        out.write("                                    </button>\r\n");
        out.write("                                </div>\r\n");
        out.write("                            </div>\r\n");
        out.write("\r\n");
  ...
  private boolean _jspx_meth_c_if_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${ ('DIPI' == sessionSgDivisao && sessionSgSetor == 'SIC')  || sessionPerfil == 'Administrador'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
