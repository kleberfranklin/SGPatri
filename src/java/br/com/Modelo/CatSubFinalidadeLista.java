 ...
 * @author d732229
 */
public class CatSubFinalidadeLista implements Logica {
    @Override
    public String executa(HttpServletRequest req, 
            HttpServletResponse res) throws Exception {
         
    CatSubFinalidadeDAO catFinDAO = new CatSubFinalidadeDAO();
...
//Carregando a quantidade de registro para calculdo da quantidade de paginas        
        qtdRegistro = catFinDAO.qdCatSubFinalidade(q);
...
//Logica da paginação            
    ...
    //Populando o objeto lista 
        List<CatSubFinalidade> listCatSub = new CatSubFinalidadeDAO().listCatSubFinalidade(qtdLinha, offset, q);
        req.setAttribute("listCatSub", listCatSub);
    
        return "CatSubFinalidadeLista.jsp?pg="+pg+"&pi="+pi+"&pf="+pf+"&qtdPg="+qtdPg+"&totalRes="+qtdRegistro+"&q="+q;
