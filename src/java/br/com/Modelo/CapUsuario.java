...
//Construtor
    ...
    public CapUsuario(int pkDivisao, int pkSetor, int nrAtivo, int pkPerfil, int pkCargo, String nmLogin, String nmNome, String nmRf, String nmEmail, String nmLoginAtualizacao) {
