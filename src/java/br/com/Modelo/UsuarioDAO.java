...
//MEDOTO de inserir um novo usuário
    public void cUsuario(Usuario us) throws SQLException {
        ...
        String sql = "INSERT INTO tbl_usuario (fk_divisao, fk_setor, nr_ativo, fk_perfil, fk_cargo, nm_login, "
...
//METODO alterar informação do usuario
    public void altUsuario(Usuario us) throws SQLException{
        PreparedStatement stmt = null;
...
//                    + "nm_login, nm_nome, sg_divisao, nm_divisao, sg_setor, nm_setor, nm_rf, "
//                    + "nm_cargo, nm_perfil, dthr_atualizacao "
...
// public int qtdUsuario() throws SQLException{
//        PreparedStatement stmt =null;
//        ResultSet rs = null;
//        int qtdUs = 0;
