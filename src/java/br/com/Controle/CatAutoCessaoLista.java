 ...
 * @author d732229
 */
public class CatAutoCessaoLista implements Logica {
    @Override
    public String executa(HttpServletRequest req, 
            HttpServletResponse res) throws Exception {
         
    CatAutoCessaoDAO autoDAO = new CatAutoCessaoDAO();
...
//Carregando a quantidade de registro para calculdo da quantidade de paginas        
        qtdRegistro = autoDAO.qdCatAutoCessao(q);
...
//Logica da paginação            
    ...
    //Populando o objeto lista 
        List<CatAutoCessao> listAuto = new CatAutoCessaoDAO().listCatAuto(qtdLinha, offset, q);
        req.setAttribute("listAuto", listAuto);
    
        return "CatAutoCessaoLista.jsp?pg="+pg+"&pi="+pi+"&pf="+pf+"&qtdPg="+qtdPg+"&totalRes="+qtdRegistro+"&q="+q;
    }
