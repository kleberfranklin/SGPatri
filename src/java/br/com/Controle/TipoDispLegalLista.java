 ...
 * @author d732229
 */
public class TipoDispLegalLista implements Logica {
    
    @Override
    public String executa(HttpServletRequest req, 
            HttpServletResponse res) throws Exception {
         
    TipoDispositivoLegalDAO tpdispDAO = new TipoDispositivoLegalDAO();
...
//Carregando a quantidade de registro para calculdo da quantidade de paginas        
        qtdRegistro = tpdispDAO.qdTipoDispLegal(q);
...
//Logica da paginação            
    ...
    //Populando o objeto lista 
        List<TipoDispositivoLegal> listTpDisp = new TipoDispositivoLegalDAO().listTipoDispLegal(qtdLinha, offset, q);
        req.setAttribute("listTpDisp", listTpDisp);
    
        return "TipoDispLegalLista.jsp?pg="+pg+"&pi="+pi+"&pf="+pf+"&qtdPg="+qtdPg+"&totalRes="+qtdRegistro+"&q="+q;
