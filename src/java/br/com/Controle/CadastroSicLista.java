...
//Logica da paginação            
   ...
   // Populando o objeto lista 
        List<CadastroSic> listSic = new CadastroSicDAO().listCadSic(qtdLinha, offset, q);
        req.setAttribute("listSic", listSic);
    
        return "CadastroSicLista.jsp?pg="+pg+"&pi="+pi+"&pf="+pf+"&qtdPg="+qtdPg+"&totalRes="+qtdRegistro+"&q="+q;
    }
