 ...
 * @author d732229
 */
public class CatFinalidadeLista implements Logica {
    @Override
...
//Carregando a quantidade de registro para calculdo da quantidade de paginas        
        qtdRegistro = catFinDAO.qdCatFinalidade(q);
...
//Logica da paginação            
    ...
    //Populando o objeto lista 
        List<CatFinalidade> listCatFin = new CatFinalidadeDAO().listCatFinalidade(qtdLinha, offset, q);
        req.setAttribute("listCatFin", listCatFin);
    
        return "CatFinalidadeLista.jsp?pg="+pg+"&pi="+pi+"&pf="+pf+"&qtdPg="+qtdPg+"&totalRes="+qtdRegistro+"&q="+q;
