 ...
 * @author d732229
 */
public class CatContrapartidaLista implements Logica {
    @Override
...
//Carregando a quantidade de registro para calculdo da quantidade de paginas        
        qtdRegistro = catContraDAO.qdCatContrapartida(q);
...
//Logica da paginação            
    ...
    //Populando o objeto lista 
        List<CatContrapartida> listCatContra = new CatContrapartidaDAO().listCatContra(qtdLinha, offset, q);
        req.setAttribute("listCatContra", listCatContra);
    
        return "CatContrapartidaLista.jsp?pg="+pg+"&pi="+pi+"&pf="+pf+"&qtdPg="+qtdPg+"&totalRes="+qtdRegistro+"&q="+q;
