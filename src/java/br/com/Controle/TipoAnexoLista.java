 ...
 * @author x369482
 */
public class TipoAnexoLista implements Logica {
...
//Carregando a quantidade de registro para calculdo da quantidade de paginas        
        qtdRegistro = tpAnDAO.qdTipoAnexo(q);
...
//Logica da paginação            
        ...
        List<TipoAnexo> listTpAn = new TipoAnexoDAO().listTipoAnexo(qtdLinha, offset, q);
        req.setAttribute("listTpAn", listTpAn);

        return "TipoAnexoLista.jsp?pg=" + pg + "&pi=" + pi + "&pf=" + pf + "&qtdPg=" + qtdPg + "&totalRes=" + qtdRegistro + "&q=" + q;
