<%-- 
    Document   : TipoDespachoLista
    Created on : 01/04/2019, 11:46:46
    Author     : x369482
--%>
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-sm-12" >
                        ...
                        <table id="simple-table" class="table  table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Nome</th>
                                    <th class="col-md-3">
                                        <form class="form-search" action="ControllerServlet?acao=TipoDespachoLista" method="POST">
                        ...
                        <button class="btn btn-success" type="button" onclick="location.href = 'TipoDespachoCRU.jsp?execucao=insert'">
                        ...
                        <div class="col-xs-6">
                            <div class="dataTables_info" id="dynamic-table_info" role="status" aria-live="polite">
                                <label class="lead">  <strong><c:out value="${totalRes}"></c:out> </strong> Tipo de Despacho(s) 
                            ...
                            <div class="dataTables_paginate paging_simple_numbers" id="dynamic-table_paginate">
                                <ul class="pagination">
                                    <c:forEach var="i" begin="${pi}" end="${pf}">
                                        <c:if test="${pi != 0 && pi == i}">
                                            <li>
                                                <a href="ControllerServlet?acao=TipoDespachoLista&pg=${i}&pi=${pi}&pf=${pf}&q=${q}">
                                        ...
                                        <c:if test="${i != 0 && i != pf && i <= qtdPg || i == qtdPg}">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <li>
                                                        <a href="ControllerServlet?acao=TipoDespachoLista&pg=${i}&pi=${pi}&pf=${pf}&q=${q}">${i}</a>
                                                    </li>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:if>
