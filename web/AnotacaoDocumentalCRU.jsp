<%-- 
    Document   : AnotacaoDocumentalCRU
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="col-sm-offset-1 col-sm-10">
                            <h2 class="title ">Guarda Documental</h2>
                            ...
                            <div class="form-horizontal">
                                <div class="tabbable">
                                    ...
                                    <div class=" tab-content profile-edit-tab-content">
                                        <div id="cad-escrituras" class="tab-pane active">
                                            <form action="ControllerServlet?acao=" method="POST" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-5 col-xs-12">
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-4 col-xs-12" name="nrRegistro" 
                                                    ...
                                                    <label class="col-xs-3 col-xs-12">
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-6 col-xs-12" name="nrPasta" 
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="nmNome" 
                                                                       value="${sgd.nmNome}" placeholder="Nome do Autor" required="required">
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="nmNome" 
                                                                       placeholder="Nome do Autor" required="required" >
                                                            </c:when>
                                                            <c:otherwise>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-7 col-xs-10" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-4 col-xs-12" name="cdProcesso" 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-7 col-xs-10" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-4 col-xs-12" name="nmTipo" 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-5 col-xs-12" >
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-10 col-xs-12" name="nmendereco" value="${sgd.nmEndereco}"  placeholder="Nome do Endereço" required="required">
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-10 col-xs-12" name="nmendereco" placeholder="Nome do Endereço" required="required">
                                                            </c:when>
                                                            <c:otherwise>
                                                    ...
                                                    <label class="col-xs-2 col-xs-12" >
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-8 col-xs-12" name="nrnumeroend" value="${sgd.nrEndereco}" placeholder="Nº Endereço">
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-8 col-xs-12" name="nrnumeroend" placeholder="Nº Endereço">
                                                            </c:when>
                                                            <c:otherwise>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-7 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="nmcomplementoend" value="${cadsic.nmComplementoEndereco}" placeholder="Complemento do Endereço" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="nmcomplementoend" placeholder="Complemento do Endereço" >
                                                            </c:when>
                                                            <c:otherwise>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-7 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="nmreferenciaend" value="${sgd.nmReferencialEndereco}" placeholder="Referencia do Endereço" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="nmreferenciaend" placeholder="Referencia do Endereço" >
                                                            </c:when>
                                                            <c:otherwise>
                                                ...
                                                <div class="form-actions center">
                                                    <button class="btn btn-yellow" type="reset" onclick=" location.href = 'AnotacaoDocumental.jsp';">
                                        ...
                                        <!--FIM DA TAB-PANE DE ESCRITURAS LAVRADAS-->
                                            ...
                                            <form action="ControllerServlet?acao=" method="POST" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-5 col-xs-12">
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-4 col-xs-12" name="nrCodigo" 
                                                    ...
                                                    <label class="col-xs-3 col-xs-12">
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-6 col-xs-12" name="cdPasta" 
                                                                       value="${sgd.cdPasta}" placeholder="Nº da Pasta" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-6 col-xs-12" name="cdPasta" 
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="nmInteressado" 
                                                                       value="${sgd.nmInteressado}" placeholder="Nome do Interessado" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="nmInteressado" 
                                                ...
                                                <div class="form-group">
                                                    <div class="col-xs-2 col-xs-12">
                                                        <span class="lbl"><strong>Área Necessária:</strong></span>
                                                    </div>

                                                    <label class="col-xs-2 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-10 col-xs-12" name="cdArea" 
                                                    ...
                                                    <label class="col-xs-2 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-12 col-xs-12" name="cdPerimetro" 
                                                    ...
                                                    <div class="col-xs-1 col-xs-12">
                                                        <span class="lbl"><strong>Imissao de Posse:</strong></span>
                                                    </div>

                                                    <label class="col-xs-1 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <div class="input-group col-xs-1 col-xs-12">
                                                                    <input class="" id="id-date-picker-1" name="dtImissaoPosse" 
                                                                           value="${sgd.dtImissaoPosse}" type="date" placeholder="dd/mm/aaaa" data-date-format="dd/mm/yyyy" 
                                                                           required="required">
                                                            ...
                                                            <c:when test="${execucao == 'insert'}">
                                                                <div class="input-group">
                                                                    <input class="" id="id-date-picker-1" name="dtImissaoPosse" type="date" 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-2 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-10 col-xs-12" name="cdArea" 
                                                                       value="${sgd.cdArea}" placeholder="Área Remanescente" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-10 col-xs-12" name="cdArea" 
                                                                       placeholder="Área Remanescente" >
                                                            </c:when>
                                                            <c:otherwise>
                                                                <span class="lbl">${sgd.cdArea}</span> 
                                                            </c:otherwise>
                                                    ...
                                                    <label class="col-xs-2 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-12 col-xs-12" name="cdPerimetro" 
                                                                       value="${sgd.cdPerimetro}" placeholder="Perímetro Remanescente" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-12 col-xs-12" name="cdPerimetro" 
                                                                       placeholder="Perímetro Remanescente" >
                                                            </c:when>
                                                            <c:otherwise>
                                                                <span class="lbl">${sgd.cdPerimetro}</span> 
                                                            </c:otherwise>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-2 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-10 col-xs-12" name="nrAuto" 
                                                    ...
                                                    <label class="col-xs-2 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-10 col-xs-12" name="dtAno" 
                                                    ...
                                                    <label class="col-xs-2 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-10 col-xs-12" name="cdVara" 
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="dsPlano" 
                                                                       value="${sgd.dsPlano}" placeholder="Descrição do Plano" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-7 col-xs-12" name="dsPlano" 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-5 col-xs-10" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-4 col-xs-12" name="cdPlanta" 
                                                                       value="${sgd.cdPlanta}" placeholder="Código da Planta" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-4 col-xs-12" name="cdPlanta" 
                                                                       placeholder="Código da Planta">
                                                            </c:when>
                                                            <c:otherwise>
                                                    ...
                                                    <label class="col-xs-3 col-xs-12" >
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-6 col-xs-12" name="cdCroqui" 
                                                                       value="${sgd.cdCroqui}" placeholder="Nº do Croqui" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-6 col-xs-12" name="cdCroqui" 
                                                                       placeholder="Nº do Croqui">
                                                            </c:when>
                                                            <c:otherwise>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-5 col-xs-12">
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-6 col-xs-12" name="cdProcesso" 
                                                                       value="${sgd.cdProcesso}" placeholder="nº do processo" required="required">
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-6 col-xs-12" name="cdProcesso" 
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-8 col-xs-12" name="nmTipo" 
                                                                       value="${sgd.nmTipo}" placeholder="Tipo de Processo" >
                                                            </c:when>
                                                            <c:when test="${execucao == 'insert'}">
                                                                <input type="text" id="form-field-1" class="col-xs-8 col-xs-12" name="nmTipo" 
                                                ...
                                                <div class="form-group">
                                                    <div class="col-xs-2 col-xs-12">    
                                                        <span class="lbl"><strong>Registro de Imóvel:</strong></span>
                                                    </div>
                                        ...
                                        <!-- FIM DA TAB-PANE DE FICHAS ELETRONICAS-->

                                        <!--Inicio da tab-pane Aforamento -->
                                            ...
                                            <form action="ControllerServlet?acao=" method="POST" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-xs-3 col-xs-12">
                                                        <c:choose>
                                                            <c:when test="${execucao == 'edit'}">
                                                                <input type="text" id="form-field-1" class="col-xs-8 col-xs-12" name="nmForeiro" 
