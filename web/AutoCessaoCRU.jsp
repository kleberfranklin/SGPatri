            ...
            <div class="tabbable">
                <ul class="nav nav-tabs padding-0">
                    <li class="active">
                        <a data-toggle="tab" href="#auto-cessao" aria-expanded="true">
                            Auto de Cessão 
                            <c:if test="${auto.nrVerAc == '1'}">
                                <span class="badge badge-transparent" title="Ok"><i class="ace-icon fa fa-check-square-o green bigger-130"></i></span>
                            </c:if>
                        </a>
                    </li>
                    <li class="">
                        <a data-toggle="tab" href="#contrapartida" aria-expanded="true">
                            Contrapartida
                            <c:if test="${auto.nrVerContrapartida == '1'}">
                                <span class="badge badge-transparent" title="OK"><i class="ace-icon fa fa-check-square-o green bigger-130"></i></span>
                            </c:if>
                        </a>
                    </li>
                    ...
                    <li class="">
                        <a data-toggle="tab" href="#anexar-doc" aria-expanded="true">
                           Anexar documento
                            <c:if test="${ (auto.nrVerArqAc == '1' && auto.nrVerArqPlanta == '1') }">
                                <span class="badge badge-transparent" title="Ok"><i class="ace-icon fa fa-check-square-o green bigger-130"></i></span>
                            </c:if>
                        </a>
                    </li>
                    <li class="">
                        <a data-toggle="tab" href="#vistoria" aria-expanded="true">
                            Vistoria
                            <c:if test="${ (auto.nrVerVitoria == '1' && auto.nrVerArqPlanta == '1') }">
                                <span class="badge badge-transparent" title="OK"><i class="ace-icon fa fa-check-square-o green bigger-130"></i></span>
                            </c:if>
                        </a>
                    </li>
                    <li class="">
                        <a data-toggle="tab" href="#validacao" aria-expanded="true">
                            Validação
                            <c:if test="${auto.nrVerValidacao == '1'}">
                                <span class="badge badge-transparent" title="OK"><i class="ace-icon fa fa-check-square-o green bigger-130"></i></span>
                            </c:if>
                        </a>
                    </li>
                ...
                <div class="tab-content profile-edit-tab-content">
                    <div id="auto-cessao" class="tab-pane in active">
                        <h5 class="header smaller lbl"><strong>Auto de Cessão</strong></h5>
...
<!--Inicio da tab-pane Contrapartida-->                        
                    <div id="contrapartida" class="tab-pane 
                         <c:if test="${auto.pkAutoStage ==1}">
                            disabled-li-menu    
                         </c:if>
                         ">
                    <h5 class="header smaller lbl "><strong>Contrapartida</strong></h5>
                    <div class="form-group">
                        <label class="inline col-md-3 col-xs-12" >
                        ...
                        <label class="inline col-md-6 col-xs-12">
                            <c:choose>
                                <c:when test="${execucao == 'edit'}">
                                    <select class="col-md-8 col-xs-12" name="pkCatContrapartida">
                                ...
                                <c:when test="${execucao == 'insert'}">
                                    <select class="col-md-8 col-xs-12" name="pkCatContrapartida" required="required">
                                        <option></option>
                                        <c:forEach var="catContra" items="${CatContra.listSelectCatContra()}">
                                            <option value="${catContra.pkCatContrapartida}" title="${catContra.nmCatContrapartida}">${catContra.nmCatContrapartida}</option>  
                                        </c:forEach>
                        ...
                        <label class="inline col-md-3 col-xs-12">
                            <a href="#" class="add_field_button" title="Adicionar outro categoria" title="Adicionar campos"><span class="label label-success arrowed"><i class=" glyphicon glyphicon-plus-sign"></i></span></a>
                        </label>
                    </div>
                    <div class="space-1"></div>
                        ...
                        <form action="ControllerServlet?acao=AutoCessaoValidacaoDispLegalUC" method="POST" >
                            ...
                            <div class="input_fields_wrap">
                                <div class="form-group">
                                    ...
                                    <label class="inline col-md-3 col-xs-12">
                                        <input type="number" min="1" id="form-field-1" class="col-xs-12 col-md-12" placeholder="numero" name="numDispositivo" >
                                    </label>
                                    ...
                                    <label class="inline col-md-1 col-xs-12">
                                        <div class="input-group">
                                            <input class="form-control" name="dtDispositivo" type="date" placeholder="dd/mm/aaaa" data-date-format="dd/mm/yyyy">
                                            <a href="#" class="add_field_button" title="Adicionar dispositivos" title="Adicionar campos"><span class="label label-success"><i class=" glyphicon glyphicon-plus-sign"></i></span></a>
                                        </div>
                                    </label>
                                    <label class="inline col-md-offset-1 col-md-2 col-xs-12">
...
<!--Inicico da tab-pane Anexer Documento -->
                    <div id="anexar-doc" class="tab-pane 
                      <c:if test="${auto.pkAutoStage ==null}">
                            disabled-li-menu    
                         </c:if> 
                     ">
...
<!--Inicio da tab-pane Vistoria -->
                    <div id="vistoria" class="tab-pane 
                        <c:if test="${auto.pkAutoStage ==null}">
                            disabled-li-menu    
                        </c:if>
                        ">
                        <h5 class="header smaller lbl"><strong>Vistoria</strong></h5>
...
<!-- Inicio do formulario Validação -->                             
                    <div id="validacao" class="tab-pane 
                     ...
                     ">
                    <h5 class="header smaller lbl"><strong>Validação</strong></h5>
                    <c:if test="${sessionSgDivisao == 'DDPI' && sessionSgSetor == 'SCL' && execucao == 'Validado'}">
