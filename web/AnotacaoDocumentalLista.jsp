<%-- 
    Document   : AnotacaoDocumentalLista
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <div class="form-actions col-lg-12 col-lg-12">
                            ...
                            <form class="form-search " action="ControllerServlet?acao=PesquisaSgdListaPagFiltro" method="POST">
                                ...
                                <label class="col-xs-2 col-xs-1 "> Processo:</label>
                                <div class="col-xs-4 col-xs-12">
                                    <input type="text" name="cdProcesso" placeholder="<c:out value="${cdProcesso}" />" class="col-xs-8 col-xs-12" />
                                </div>

                                <label class="col-xs-12 col-xs-1" > Interessado:</label>
                                <div class="col-xs-3 col-xs-12">
                                    <input type="text" name="nmInteressado" placeholder="<c:out value="${nmInteressado}"/>" class="col-xs-10 col-xs-12" />
                                </div>
                                ...
                                <div class="col-sm-4 col-xs-12">
                                    <input type="text" name="nmAssunto" placeholder="<c:out value="${nmAssunto}" />" class="col-xs-10 col-xs-12" />
                                </div>
                                ...
                                <div class="col-sm-4 col-xs-12">
                                    <input type="text" name="cdCroqui" placeholder="<c:out value="${cdCroqui}" />"  class="col-xs-4 col-xs-12" />
                                </div>
                        ...
                        <div class="col-sm-12 " >
                            <button class="btn btn-yellow right" type="reset" onclick=" location.href = 'AnotacaoDocumental.jsp?ter=${ter}';">
