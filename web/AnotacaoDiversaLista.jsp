<%-- 
    Document   : AnotacaoDiversaLista
    Created on : 01/02/2019, 13:07:38
    Author     : x369482
--%>
...
<html>
    ...
    <body class="no-skin">
        ...
        <div class="main-container ace-save-state" id="main-container">
            ...
            <!--        < id="aExpediente" class= "br.com.Modelo.AnotacaoExpedienteDAO"/> -->
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        ...
                        <div class="form-actions col-lg-12 col-lg-12">
                            ...
                            <form class="form-search " action="ControllerServlet?acao=AnotacaoDiversaListaPagFiltro" method="POST">
                                ...
                                <label class="col-xs-2 col-xs-1 "> Setor:</label>
                                <div class="col-xs-4 col-xs-12">
                                    <input type="text" name="cdSetor" placeholder="<c:out value="${cdSetor}" />"  class="col-xs-5 col-xs-12" />
                                </div>

                                <label class="col-xs-2 col-xs-1 "> Quadra:</label>
                                <div class="col-xs-3 col-xs-12">
                                    <input type="text" name="cdQuadra" placeholder="<c:out value="${cdQuadra}" />"  class="col-xs-7 col-xs-12" />
                                </div>

                                <label class="col-xs-2 col-xs-1 "> Lote:</label>
                                <div class="col-xs-2 col-xs-12">
                                    <input type="text" name="cdLote" placeholder="<c:out value="${cdLote}" />"  class="col-xs-10 col-xs-12" />
                                </div>

                                <!--Botoes-->
                                <span class="input-group-btn col-sm-6 col-sm-6">
                        ...
                        <table id="simple-table" class="table  table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="hidden-480">Quadra </th>
                                    <th class="hidden-480">Lote </th>
                            ...
                            <c:forEach var="listSgd" items="${listSgd}">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="hidden-480" title="${sgdLista.cdSetor}">
                                            <c:choose >
                                                <c:when test="${sgdLista.cdSetor.length() > 10 }">
                                                    ${sgdLista.cdSetor.substring(0,10)}...
                                                </c:when>
                                        ...
                                        <td class="hidden-480" title="${sgdLista.cdQuadra}">
                                            <c:choose >
                                                <c:when test="${sgdLista.cdQuadra.length() > 10 }">
                                                    ${sgdLista.cdQuadra.substring(0,10)}...
                                                </c:when>
                                        ...
                                        <td class="hidden-480" title="${sgdLista.cdLote}">
                                            <c:choose >
                                                <c:when test="${sgdLista.cdLote.length() > 10 }">
                                                    ${sgdLista.cdLote.substring(0,10)}...
                                                </c:when>
                                ...
                                <ul class="pagination">
                                    ...
                                    <c:forEach var="i" begin="${pi}" end="${pf}">
                                        ...
                                        <c:if test="${i == pf && pf != qtdPg && i <= qtdPg  }">
                                            <li>
                                                <a href="ControllerServlet?acao=AnotacaoExpedienteListaPagFiltro&pg=${i}&pi=${pi}&pf=${pf}&cdProcesso=${cdProcesso}&nmInteressado=${nmInteressado}&nmAssunto=${nmAssunto}&cdCroqui=${cdCroqui}&ter=${ter}"/>
                        ...
                        <div class="col-sm-12 " >
                            <button class="btn btn-yellow right" type="reset" onclick=" location.href = 'AnotacaoDiversa.jsp?ter=${ter}';">
