...
<!--Verificação de acesso  -->
    ...
    <jsp:useBean id="TpCessao" class= "br.com.Modelo.TipoCessaoDAO" />
    <jsp:useBean id="TpCessaoTer" class= "br.com.Modelo.TipoCessaoDAO" />
    <jsp:useBean id="dpLegal" class= "br.com.Modelo.DispositivoLegalDAO" />
